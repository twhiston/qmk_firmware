 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | BACKS  | A      | S      | H      | T      | G      | HOME   | DEL    | PG UP  | Y      | N      | E      | O      | I      | ENTER  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 ...
 */
 ...
 [_WM] = { /* QWERTY */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_MINS, KC_GRV,  KC_EQL,  KC_6,   KC_7,   KC_8,    KC_9,    KC_0,    KC_CAPS },
  { KC_TAB,  KC_Q,    KC_D,    KC_R,    KC_W,   KC_B,   KC_LBRC, KC_BSLS, KC_RBRC, KC_J,   KC_F,   KC_U,    KC_P,    KC_SCLN, KC_QUOT },
  { KC_BSPC, KC_A,    KC_S,    KC_H,    KC_T,   KC_G,   KC_HOME, KC_DEL,  KC_PGUP, KC_Y,   KC_N,   KC_E,    KC_O,    KC_I,    KC_ENT  },
