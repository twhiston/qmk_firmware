...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_WO] = { /* WORKMAN */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,    MO(_FUN), TG(_NUM),       TG(_QW), KC_6,    KC_7,   KC_8,    KC_9,    KC_0,    CTL_T(KC_ESC) },
  { KC_TAB,  KC_Q,    KC_D,    KC_R,    KC_W,   KC_B,    KC_GRV,   KC_HOME,        KC_QUOT, KC_J,    KC_F,   KC_U,    KC_P,    KC_SCLN, KC_BSLS },
  { KC_BSPC, KC_A,    KC_S,    KC_H,    KC_T,   KC_G,    KC_EQL,   KC_UP,          KC_MINS, KC_Y,    KC_N,   KC_E,    KC_O,    KC_I,    KC_DEL  },
  { KC_LSFT, KC_Z,    KC_X,    KC_M,    KC_C,   KC_V,    KC_LEFT,  KC_DOWN,        KC_RGHT, KC_K,    KC_L,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT },
  { KC_MEH,  KC_LGUI, KC_LALT, KC_LEFT, KC_RGHT,KC_LCBR, KC_SPC,   LGUI_T(KC_ENT), KC_SPC,  KC_RCBR, KC_DOWN,KC_UP,   KC_RALT, KC_RGUI, MO(_SYM)},
 },
